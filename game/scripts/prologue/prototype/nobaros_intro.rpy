label nobaros_intro:
    ...
    "Unfortunately, nothing else comes to mind."
    "You recall that he mentioned the afterlife, and anxiously ask if you're dead."
    "He thinks for a bit, wondering where to start."
    "First, he reassures you that you aren't necessarily done for. In fact, you are a special case called a 'vagabond'."
    "Vagabonds are those whose spirits are caught between life and death. For example, being stuck in a coma after an accident."
    "Vagabonds tend to arrive in Nobaros as amnesiacs, which appears to be your situation."
