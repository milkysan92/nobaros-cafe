label maple_grove:
    ...
    narrator "Izumi hurries to pack up our lunches, closing them up in a matter of seconds. His eagerness gives me hope that I made the right decision."
    narrator "Soon, we're on our feet, ready to try something new for the photoshoot."
    scene blank with bgwipe
    scene momiji_shrine with bgwipe
    show izumi at left
    show himari at right
    with dissolve
    narrator "After some walking, we eventually arrive at a shrine. There's noticeably a larger crowd here compared to the open area where we ate lunch."
    narrator "Several families and couples loiter around, happily chattering amongst themselves under the crimson red of the maple trees."
    izumi "So many maple trees. . ."
    narrator "Seeing the sparkles in Izumi's eyes brings a smile to my face."
    show izumi smile with faceswap
    narrator "Although he doesn't say much at the sight of the grove, his body language speaks volumes about how much he's been looking forward to this."
    hide izumi smile with dissolve
    show himari:
        right
        easein 1.0 center
    narrator "He steps forward eagerly, his gaze sweeping over the vibrant hues of the maple leaves with an almost childlike wonder."
    narrator "There's a lightness to his movements, a sense of anticipation palpable in the way he takes in every detail of the scene before him."
    ch2_emi "(Who's the one that's excited now?)"
    narrator "I can't help but chuckle at his giddiness."
    narrator "Just then, I feel a tug from below. Averting my gaze down to the edge of my coat, I find the same child that I ran into earlier, waving at me with a cheerful glee."
    ...
    narrator "He smiles brighter and nods excitedly, sticking a hand out at me."
    ...
    show himari:
        center
        easein 1.0 right
    show izumi smile at left with dissolve
    ...
    izumi "E-eh?!"
    narrator "Suddenly, Haruto gets right up in Izumi's face, fascinated by his camera. The unexpected attention flusters Izumi, leaving him momentarily unsure of how to respond."
    ...
    show izumi with faceswap
    narrator "Izumi squats down to Haruto's level, carefully holding the camera for him to see. I watch as Haruto's eyes widen with curiosity and excitement."
    ...
    narrator "He begins to explain how the camera works, pointing to each part while mentioning what they're for. Haruto listens intently, completely absorbed in Izumi's explanation."
    ...
    show izumi smile with faceswap
    narrator "As Izumi talks, his face lights up with a heartwarming smile. It's clear that he's enjoying himself, and I can't help but feel a wave of joy at the sight."
    ...
    narrator "Just then, Haruto's grandparents come into view, their faces breaking into wide smiles at the sight of him. With a joyful shout, he runs straight into their open arms, and they embrace him lovingly."
    ...
    show izumi with faceswap
    narrator "Izumi takes out his phone, flipping through blog posts as he showcases his photos to the three of them."
    ...
    narrator "Izumi rubs the back of his head, a little embarrassed from the old man's praise."
    show izumi with faceswap
    ...
    narrator "Izumi's face lights up as soon as he receives their permission."
    show izumi with faceswap
    narrator "He scours the area for a moment, until his eyes land on a grand maple tree shrouded in sunlight in a lone corner of the shrine."
    izumi "Could I have you guys stand over there? I think that maple tree might make for a very nice backdrop."
    narrator "As Izumi directs the three of them to the tree, I can't help but follow behind with a warm feeling in my heart."
    narrator "The three of them gather closely, standing proud and tall under the tree's branches while Izumi stands at a distance, assessing the scene's aesthetic."
    narrator "With a gentle voice, he instructs them to adjust their poses and tilt their heads slightly."
    narrator "After some adjustments, Izumi begins snapping various headshots and portraits of them. His eyes are filled with concentration, completely focused on capturing the perfect shot."
    narrator "During the little photoshoot, I watch Izumi closely as he interacts with the family."
    narrator "His movements are deliberate and confident, with each adjustment and click of the shutter demonstrating his expertise. The disappointed look from earlier has completely vanished, replaced by immense love and passion for his craft."
    ch2_emi "(He's really enjoying himself. I'm glad I consulted Ingram earlier.)"
    show izumi smile with faceswap
    narrator "After taking some stellar shots, Izumi shows them to the family. Upon seeing the pictures, their faces glow with happy smiles, brimming with joy."
    ...
    narrator "The old man starts welling up with tears, surrounded by his wife and grandson. Izumi and I look at each other, unsure of what to do."
    narrator "Izumi digs through his bag, finding some pocket tissues that he offers to the old man, who graciously accepts."
    show himari with faceswap
    ...
    narrator "The old lady consoles her husband, gently patting his back as he wipes away his tears. After a moment, she turns towards us with a warm, grateful smile, her eyes glistening with emotion."
    ...
    narrator "As Izumi figures out how to share the photos with the grandparents, a tender feeling fills my heart. He seems to be more animated than before."
    narrator "We eventually say goodbye to the family and begin to head home."
    scene blank with bgwipe
    ...
    narrator "Izumi looks at me with a sincere smile, the happiest he's been all day."
    narrator "Seeing him this content, realizing that his passion has evolved into something more profound, fills me with a sense of joy."
    ...
    narrator "In the blink of an eye, I strike the first pose that comes to mind."
    izumi ". . .Cheese!"
    scene blank with Fade(0.08, 0.1, 1.0, color="#fff")
    narrator ". . ."
    pause(0.3)
    scene sweven_mirror with swevenwipe_ccw
    show emi at left
    show ingram at right
    with dissolve
    emi ". . ."
    ingram "Welcome back. It's all done now."
    emi "Hmm. . .?"
    narrator "I slowly open my eyes, seeing Ingram standing right in front of me."
    emi "I'm back. . ."
    ...
    show emi:
        ...
        easein 1.0 center
    pause(1.0)
    show sweven_mirror behind emi with Fade(0.5, 0.1, 1.0, color="#d9feff")
    emi ". . .Huh?"
    narrator "Just as I'm about to follow Ingram home, I suddenly hear a faint hum from behind me. Turning around, I manage to catch a glimpse of a pulse of light being emitted from the mirror."
    narrator "A small ball of light pops out of the mirror, descending slowly in the air like an angel's  feather."
    narrator "I catch the little light in my hands and it fades upon contact, revealing a photograph within."
    emi "(Huh, it turned out pretty well in the end!)"
    narrator "I feel a smile forming as I stare at the selfie that Izumi and I took earlier."
    narrator "In the end, all I managed was a simple smile and a peace sign in the nick of time. Izumi, on the other hand, has the biggest grin on his face, his eyes wrinkling from how much he's smiling."
    emi "(Rest in peace, Izumi. I'm sure your sister would be very proud of what you achieved here.)"
    narrator "I decide to hold onto the photograph, carrying Izumi's legacy with me."
