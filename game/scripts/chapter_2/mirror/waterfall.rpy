label waterfall:
    ...
    narrator "Izumi nods, complying with my decision."
    izumi "Okay, if that's what you think. I'll follow you."
    narrator "He quickly packs up our lunches, and soon we're on our feet, eager to try something new for the photoshoot."
    ...
    narrator "After treading down the path for a while, I eventually manage to pick up the faint sounds of crashing water again."
    ch2_emi "I hear the waterfall! We're almost there, it's just right up ahead!"
    narrator "I grow excited and prepare myself to run down the path, only to be stopped by Izumi's firm grip on my wrist."
    ...
    narrator "Izumi walks past me, his mouth agape as he takes in the breathtaking sight before him."
    ...
    narrator "I scan the area, searching for someone who might be open to modelling."
    ...
    narrator "Izumi sighs in relief at my suggestion."
    show izumi smile at left with faceswap
    izumi "I'm down for that idea. Let me get my camera ready then."
    show izumi at left with faceswap
    narrator "Izumi uncaps his camera and double-checks everything, moving excitedly."
    ...
    show himari:
        right
        easein 1.0 center
    narrator "I nod at Izumi's advice, and cautiously make my way over to the riverbank. Taking a moment to position myself amongst the rocks, I strike a pose, flashing a bright smile."
    narrator "It takes him a moment to find the right angles but eventually, he gets into the zone and shoots away."
    narrator "With the sun slowly descending, he tries different poses and locations around the waterfall, trying to capture the perfect moment."
    scene blank with bgwipe
    scene momiji_stream with bgwipe
    show himari with dissolve
    izumi ". . .!"
    izumi "Himari, freeze! Stay right in that position, this is a good shot."
    narrator "Just as the sun casts its golden glow over me, Izumi's shutter goes off, capturing another series of photos."
    ...
    narrator "I walk over to Izumi, who is intently reviewing the photos on his camera."
    ch2_emi "How did the photos turn out? Did we capture what you were looking for?"
    show izumi at left with faceswap
    narrator "I place a hand on Izumi's shoulder and peer into the camera screen with him."
    narrator "There's an ethereal headshot of me, my expression trance-like as I gaze into the distance. The spray from the waterfall forms a rainbow, enhancing the whole composition with a delicate, shimmering backdrop."
    ...
    narrator "I turn to Izumi to ask for his opinion, but his disappointed expression stops me."
    ...
    narrator "Izumi's frustration is evident as he packs his camera away with furrowed brows. I watch him silently, trying to figure out how to comfort him."
    ...
    show himari concern:
        right
        easein 1.0 center
    narrator "Izumi smiles faintly before turning back in the direction we came from. As I trail behind him, I watch his back, unable to shake off the guilt."
    ...
    narrator "I turn my gaze away, the guilt weighing down on me like a heavy stone pressing on my chest. His question is innocent, yet it feels like an added burden, a reminder of my inability to help Izumi."
    emi "(I was so motivated to help Izumi, but in the end, he couldn't find his answer. . .)"
    narrator "I feel Ingram's stare burning into me, yet I struggle to find the words to respond to him. Before I'm able to piece together an answer to his question, he places a hand on my head."
    emi ". . . !"
    ...
    emi "Ingram. . ."
    emi "I just. . ."
    narrator "I can't help but feel glum at the bittersweet comfort in Ingram's words."
    ...
    narrator "Ingram's words lift my spirits, offering a glimmer of comfort."
    narrator "It's reassuring to think that maybe, just maybe, I did bring some happiness to Izumi. Yet a part of me hesitates to fully accept it, knowing deep down that his unfulfilled desire still lingers."
    narrator "As I mull over Ingram's perspective, his advice begins to sink in, my interactions with Izumi flashing through my mind."
    narrator "Recalling the smile on Izumi's face during the photoshoot, I realize that Ingram's words ring true. This journey wasn't entirely in vain."
