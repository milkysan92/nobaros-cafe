label sweven_mirror_2:
    ...
    uk_generic ". . .Himari!"
    sgm_emi ". . .!"
    scene ch2_bedroom with fade
    show izumi with dissolve
    sgm_emi "Huh. . .?"
    sgm_emi "Izumi?  Where am I?"
    izumi "Sigh. . .finally, you're awake."
    izumi "I've been trying to wake you up for an hour now."
    sgm_emi "Eh? What's going on?"
    ...
    izumi "Sigh, you've got to stop staying up so late. . ."
    izumi "We're supposed to head to Momiji Park. It's apparently quite scenic at this time of year."
    izumi "Especially the maple trees at Momiji Shrine. It's a popular sightseeing spot, so there's probably going to be a bit of a crowd later."
# TODO: figure out how to get text to stay during transition
    show izumi smile with faceswap
    izumi "But despite all that, I'm looking forward to seeing them myself."
    show izumi with faceswap
    izumi "Anyways, now that you're awake, I'll wait downstairs while you get ready."
    ...
    ch2_emi ". . ."
    narrator "An intrusive thought crosses my mind."
    ch2_emi "What if I just. . .?"
    narrator "Curiosity gets the better of me, and I start to raise my hands, intending to explore."
    izumi "Himari, are you done yet?"
    show himari at startle
    ch2_emi "Eek!"
    ch2_emi "I-I'll be right down! Just finishing up!"
    narrator "Izumi's voice from downstairs pulls me out of my thoughts, replacing my curiosity with a surge of embarrassment."
    ch2_emi "That was close. . ."
    ...
    ch2_emi "We made it! And we're here before lunch too!"
    narrator "As we step into the park, a brilliant display of red, orange, and gold leaves welcomes us, showcasing the beauty of the autumn season."
    narrator "A canopy of trees arches overhead, blanketing the ground in brittle leaves that rustle softly underfoot."
    ch2_emi "(The temperature's perfect, not too hot nor too cold. Perfect for a photoshoot!)"
    narrator "I glance back at Izumi, who's calmly trailing behind me."
    show himari:
        center
        easein 1.0 right
    pause(0.5)
    ...
    izumi ". . ."
    ch2_emi "What's with that look, Izumi?"
    izumi ". . .Sis, you're unusually energetic today. Are you feeling alright?"
    ch2_emi "E-eh? Ah, well, I just had a really good sleep! Yeah, that's it!"
    ch2_emi "I'm bursting with energy, so it's hard to contain! Nothing out of the ordinary here, ahaha. . ."
    ...
    scene momiji_park with bgwipe
    show himari with dissolve
    narrator "As I walk, the trail meanders through a dense thicket. The air is cool and fresh, leaving me rejuvenated with a rich, earthly scent."
    ch2_emi "(. . .Huh? Is that water?)"
    narrator "My ears pick up on the sound of rushing water from afar, growing louder with each step I take."
    ch2_emi "(Is there a lake or river down this path?)"
    ch2_emi "(Sounds exciting. Let's keep walking and find out!)"
    scene blank with bgwipe
    scene momiji_stream with bgwipe
    show himari with dissolve
    ...
    narrator "I quickly rush forward and grab the kid's arm, pulling him in just before he touches the water's surface."
    narrator "Bringing him into a more stable area, I crouch down and hold his arms, checking for any injuries."
    ch2_emi "Are you alright? Is your foot okay?"
    haruto "I-I'm okay. . ."
    show himari with faceswap
    narrator "The kid looks at me as his eyes grow teary, clearly shaken by the fall. Just then, his grandparents approach us with worried looks plastered on their faces."
    grandpa "Haruto! How many times have we told you not to run ahead of us?"
    grandpa "Especially in such a rocky area, you almost fell in! You could've drowned!"
    ...
    show himari with dissolve
    narrator "Upon my return, I notice the sun peeking through the clouds, casting a bright glow over the park. The air has grown noticeably warmer since we arrived, adding to the pleasant atmosphere."
    narrator "After some searching, I spot Izumi sitting on a bench, savoring a bento box brought from home."
    hide himari with dissolve
    scene momiji_park2 with fade
    ...
    ch2_emi "(This is the life! Homemade food really is the best.)"
    ch2_emi "By the way, Izumi, how did the photos turn out so far?"
    izumi "They're okay, I guess. Here, you can have a look if you'd like."
    narrator "Izumi momentarily stops eating, wiping his hands with a handkerchief before handing me his camera in a careful manner."
    narrator "As I browse through the gallery, my eyes are treated to beautiful compositions of nature. There are images featuring all sorts of subjects, from vibrant landscapes to detailed photos of birds amongst the trees."
    ch2_emi "These are incredible! Izumi, you-"
    show himari concern at right with faceswap
    narrator "I glance at Izumi to compliment him, but am taken aback as soon as I see the disappointed etched on his face."
    narrator "Suddenly, I'm reminded of what he said about not being satisfied with his photos, a goal that has eluded him until now."
    ch2_emi "(I thought that giving him the freedom to shoot on his own would have yielded good results, but it seems like that's not the case.)"
    ch2_emi "(The photos are stunning, but if they don't meet his standards, then this will all be for naught.)"
    ch2_emi "(The question is, how can I help him achieve what he's aiming for. . .?)"
    show himari at right with faceswap
    ch2_emi "(. . .I should get a second opinion on this. Maybe Ingram can offer some insights that will help us.)"
    ch2_emi "Izumi, I'm gonna step away for a bit. I need to call someone."
    izumi "Huh? Oh, okay then. Don't take too long, you haven't finished your lunch yet."
    ch2_emi "Don't worry, I'll be back before you know it!"
    hide himari with dissolve
    scene blank with bgwipe
    scene momiji_park2 with bgwipe
    show himari with dissolve
    ...
    narrator "Once I feel calm enough, I switch to my inner voice and begin to speak."
    ch2_emi "(Ingram, are you there? I need your advice on something.)"
    ch2_emi "(. . .)"
    ...
    ch2_emi "(Wait, you're right. I don't think I saw anybody in his gallery when I was going through it. Could it be that he doesn't have a model?)"
    ...
    ch2_emi "(Okay! I'll try convincing him to do that.)"
    ch2_emi "(Thanks Ingram, I'm gonna talk to him right now.)"
    ...
    narrator "He thinks to himself for a bit, taking my idea into consideration."
