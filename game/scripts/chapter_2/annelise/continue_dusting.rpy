label continue_dusting:
    ...
    narrator base "Eventually, I manage to finish dusting all the shelves in no time."
    ...
    emi talk "Annelise, are you a big reader? I couldn't help but notice that you have quite a few books in your pile."
    emi "That's a lot to read in one day, isn't it?"
    narrator base "Annelise snaps back to reality as she looks up from her book, surprised by my question. It seems she wasn't expecting me to make conversation with her."
    ...
    emi talk "That sounds fun! It's almost as if you're time travelling."
    annelise base ". . .!"
    ...
    emi talk "So what are you currently reading? You seem so focused on it."
    emi "Is it a good story?"
    annelise base "Oh, this is my favourite book! Let me show you."
