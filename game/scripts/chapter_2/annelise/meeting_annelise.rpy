label meeting_annelise:
    emi talk "Let's go give the library a good dusting!"
    narrator base "I promptly grab the duster hanging on the wall and make a beeline for the library."
    scene blank with bgwipe
    scene library with bgwipe
    narrator base "A sea of novels encased in ebony bookshelves comes into view. Tall glass windows frame the room, cascading the space in a blanket of soft, inviting sunlight."
    ...
    emi talk "I'm so sorry! I didn't see you there. Are you okay?"
    uk_annelise base "O-oh, um, yes! I'm fine. I was just. . . lost in my books, so I didn't realize someone else entered the room. . ."
    ...
    emi talk "Don't worry about it, it's my fault for not looking where I was going!"
    emi "Are you sure you're really alright? I didn't hurt you or anything?"
    uk_annelise base "That's okay, I was just a bit startled that's all."
    uk_annelise "Thank you for helping with the books. I didn't realize anyone else would be here today. . ."
    emi talk "Oh, I'm here to help dust the library as per Ingram's orders!"
    emi "My name's Emi by the way. I recently started helping out around the cafe, so I'm relatively new around here."
    uk_annelise base "Ah, Ingram? {w=0.2}Really? You're a friend of his?"
    narrator "Mentioning Ingram's name seems to have sparked something in the girl. Her eyes brighten with a newfound clarity."
    emi talk "Yeah, you could say that! He thought I could help pitch in with things around the cafe, so that's how I ended up here. {w=0.2}Oh, and with spirit guiding too!"
    uk_annelise base "Could you be the new girl that Ingram was mentioning? You'll be staying at Yuugen House too then?"
    emi talk "That's me! Sorry, but I don't think I caught your name?"
    uk_annelise base "Oh s-sorry! I forgot to introduce myself. My name is Annelise. It's nice to have another girl around."
    narrator "Annelise smiles timidly, feeling a tad more relaxed after realizing that I was a friend of Ingram's."
    emi talk "Alright, I won't disturb you from your reading too much then! I'll get right to cleaning, and you can go back to enjoying your book."
    annelise base "Okay, good luck with the cleaning. Let me know if you need any help."
