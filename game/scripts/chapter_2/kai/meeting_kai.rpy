label meeting_kai:
    ...
    emi talk "What a pretty charm! I wonder where it came from. . . maybe someone's necklace or something?"
    narrator base "Deciding to keep the charm in case the owner returns, I tuck it into a small apron pocket and continue sweeping the foyer."
    ...
    narrator base "I dig into my apron pocket and fish out the golden camellia charm I found earlier."
    ...
    uk_kai "Actually, I don't think I've ever seen Ingram working with {i}anyone{/i} in general. . ."
    uk_kai "But never mind that! Let me introduce myself. My name's Kai, what's yours?"
    emi talk "Oh, right, I'm Emi! I'm helping Ingram out with both the cafe and with spirit guiding."
    kai base "Wait, {w=0.3}Emi? {w=0.3}I think I know you!"
    kai "Ingram was mentioning that we'd be getting a new roommate at Yuugen House!"
    emi talk "I guess news spreads fast around here, huh?"
    kai base "Oh, it's nothing like that. Ingram just decided to gather everyone and tell us all at once." 
    ...
    emi talk "By the way, how did you lose the charm? {w=0.1}Was it from a piece of jewelry or something?"
    kai base "Oh right, let me show you!"
    ...
    narrator "Before I manage to respond, a low, rumbling sound cuts Kai's questions off."
    narrator "The two of us stare at each other in silence, confused."
    emi ". . ."
    kai ". . ."
    emi talk ". . .Was that you?"
    kai base "No way, I don't know what you're talking about. That's gotta be you."
    emi talk "But I just ate lunch a few hours ago! I think I'd know if it was my own stomach."
    narrator base "Just then, another growl rumbles. This time, it's clearly coming from Kai."
    kai ". . ."
    ...
    emi talk "You haven't eaten yet?!"
    ...
    emi talk "Okay, just wait here then. I'll have a look at what we have."
    scene blank with bgwipe
    scene cafe with bgwipe
    narrator base "I return to the counter and check the cooler where the off-display items are kept. Inside, I find a selection of desserts — pink macarons and a strawberry tart catch my eye."
