label meeting_kai:
    ...
    narrator "I grab the broom leaning against the corner and head out to the floor, collecting the day's accumulation of dust and dirt."
    scene cafe with fade
    show emi with dissolve
    narrator "Starting at each table, I create small piles, nudging them towards a corner where a larger pile awaits."
