label welcome_dinner:
    ...
    show annelise:
        xpos 1500
        easein 1.0 left
    narrator "Akira takes the vegetables to the sink and starts washing them, placing the cleaned ones in a colander."
    kai "Alright, Annelise, what do you wanna start with?"
    annelise "Hmm, let's cut the potatoes. I'll handle it!"
    narrator "Once Akira finishes cleaning the vegetables, Annelise drags the colander of cleaned vegetables over to a cutting board. Scurrying over to a kitchen drawer, she starts digging around for a knife."
    ...
    narrator "Just as Kai is about to offer a knife to her, Annelise finds a big cleaver at the back of the drawer."
    narrator "With an awkwardly threatening grip, she begins to hack away at the potatoes, chopping them into uneven chunks with questionable technique."
    kai "A-Annelise, do you need some help with that?"
    annelise "What? I'm doing fine! See?"
    narrator "Annelise smiles as she swings the cleaver at another potato, sending a piece flying towards Kai at lightning speed."
    show kai at impact with Fade(0.05, 0.0, 0.05, color="#fff")
    kai "OW!"
    annelise "Oh my gosh! I'm so sorry, Kai, are you okay?"
    kai "Yeah, I think I'm okay. . ."
    annelise "Is your forehead okay? Can I check?"
    narrator "Kai removes his hand from his forehead, revealing a big red mark in the shape of the potato piece."
    ...
    scene blank with bgwipe
    scene kitchen_night with bgwipe
    show akira at Position(xpos=-300, xanchor="left")
    show annelise at Position(xpos=1500, xanchor="center")
    show kai at Position(xpos=3250, xanchor="right")
    show ingram at Position(xpos=3300)
    with dissolve
    ...
    scene kitchen_night with dissolve
    narrator "I watch as Ingram and Kai continue to banter. It's a bit jarring to see Ingram teasing Kai like this, considering his usual calm demeanor."
    narrator "Akira notices me staring and gestures closer to me, speaking in a quiet tone so as to not draw any attention."
