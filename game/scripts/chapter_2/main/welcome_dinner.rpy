label welcome_dinner:
    ...
    emi base "Ahh, finally home! Today felt like a really long day."
    ingram "Well, we had to do some spirit guiding right after closing, after all."
    emi base "That's true. Now it's time to unwind!"
    ...
    narrator base "Peering through the doorframe, I spot Kai, Annelise and Akira gathered around the dining table. They're deep in conversation, staring at a colourful array of fresh ingredients laid out before them."
    emi talk "Hey guys! What's going on? What are you talking about?"
    show kai at left
    show annelise at center
    show akira at right
    with dissolve
    kai base "Ah! Emi, Ingram, you're back!"
    ...
    emi talk "Wow, really? That's so thoughtful of you guys, I'm honoured!"
    ingram base "So, what have you guys decided on for tonight's menu?"
    ...
    narrator "Just as Kai is about to offer a knife to her, Annelise finds a big cleaver at the back of the drawer. With an awkwardly threatening grip, she begins to hack away at the potatoes, chopping them into uneven chunks with questionable technique."
    ...
    narrator "Ingram places a hand on Kai's shoulder, earning a confused look from him. The rest of us avert our eyes from Kai, trying not to bring attention to the newly established birthmark on his head."
    ...
    narrator "Akira approaches Annelise, and she gives him the chef's cleaver with a pout. As Kai gets started on cutting the vegetables, Akira heads over to the sink and starts washing the dishes."
    ...
    narrator "Watching the three of them work together fills me with a sense of belonging. Despite the initial chaos, they eventually find their rhythm, each person contributing in their own way. Soon enough, the cooking process wraps up without any further mishaps."
    kai "Tadah! Presenting the much-anticipated nikujaga!"
    narrator "A large dish sits proudly on the dining table, containing tender slices of beef intermingled with potatoes, carrots, and onions, all simmered to perfection in a savory broth. The glossy sheen on the surface hints at the dish's deliciously hearty nature, making my mouth water with anticipation."
    ...
    narrator "With my chopsticks, I eagerly dig into the nikujaga with a generous bite. Rich, savoury umami explodes in my mouth, sending goosebumps down my arms. The tender beef, perfectly cooked potatoes, and carrots melt together into a harmonious blend of tastes that dance on my tastebuds."
    ...
    kai "Listen to me!"
    narrator "I watch as Ingram and Kai continue to banter. It's a bit jarring to see Ingram teasing Kai like this, considering his usual calm demeanor. Akira notices me staring and gestures closer to me, speaking in a quiet tone so as to not draw any attention."
    akira "Surprised?"
