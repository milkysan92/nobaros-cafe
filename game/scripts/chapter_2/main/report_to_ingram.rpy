label report_to_ingram:
    ...
    show emi with dissolve
    narrator "The cafe is bathed in a soft, golden glow, casting long shadows that dance across the floor. With only a few lingering customers left, an intimate sense of tranquility envelops the space."
    narrator "As I return to the counter, I notice Ingram standing there with a cloth in hand. Although he appears to be looking at the customers, his gaze is distant, as though he's staring at something far beyond the cafe walls."
    ...
    with dissolve
    emi "Ingram, I'm back!"
    narrator "My voice breaks his trance, drawing his previously distant eyes to focus on me. His expression shifts, a small smile playing on his lips as he turns to face my direction."
