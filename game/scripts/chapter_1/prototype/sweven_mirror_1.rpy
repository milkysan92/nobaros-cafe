label sweven_mirror_1:
    ...
    emi "Y-yeah, sorry about that. I'll go right now!"
    uk_generic "Alright, just hurry up. You heard the announcement, we don't have long!"
    emi "(Am I a staff member?)"
    emi "(Okay, that doesn't matter right now. I need to find Brio's grandfather.)"
    emi "(Now where would he be...? Should I check outside?)"
    scene blank with bgwipe
    scene concert_hall with bgwipe
    "You quickly rush outside, trying to find Brio's grandfather."
    "You find an elderly man standing, looking around nervously."
    emi "Excuse me, sir. Are you Brio's grandfather?"
