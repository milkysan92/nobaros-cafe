...
label meeting_kai:
    ...
    narrator "With the broom in hand, I start collecting the day's accumulation of dust and dirt."
    narrator "Going under each table, I create small piles, nudging them towards a corner where a larger pile awaits."
    ...
    narrator "Deciding to keep the charm in case the owner returns, I tuck it into a small apron pocket and continue sweeping the foyer."
    narrator "After collecting the dust into a dustpan and disposing of it in a nearby trashcan, I feel a sense of accomplishment." 
    narrator "Setting the broom aside momentarily, I head to the counter to wash my hands."
    narrator "Just as I'm about to finish up, the front door bursts open and a blaring voice shatters my eardrums."
    unknown_k "INGRAM!! ARE YOU IN HERE?!"
    ...
    show kai at left with dissolve
    emi "Sorry, Ingram is busy at the moment. Can I help you with something?"
    narrator "The guy looks at me desperately and claps his hands together, as if he's about to pray."
    unknown_k "Oh thank god you're here! I lost something and I think it might be somewhere around here."
    emi "What did you lose? Maybe I can help you find it."
    unknown_k "It's a small golden trinket thingy. It should look like a flower of some kind."
    emi "Wait a minute, could you be talking about this?"
    narrator "I dig into my apron pocket and fish out the golden camellia charm I found earlier."
    narrator "As I lay it in my palm and show it to him, his eyes light up, and he nods excitedly."
    unknown_k "That's the one! Thanks a bunch!"
    narrator "I offer the charm to him, which he graciously receives with both hands."
    unknown_k "By the way, you're new around here aren't you? I don't think I've ever seen someone other than Ingram working here."
    unknown_k "Actually scratch that, I don't think I've ever seen Ingram working with {i}anybody{/i}, period. . ."
    unknown_k "But never mind that! Let me introduce myself. My name's Kai, what's yours?"
    emi "Oh, right, I'm Emi! I'm helping Ingram out with both the cafe and with spirit guiding."
    kai "Wait, {w=0.3}Emi? {w=0.3}I think I know you!"
    ...
    emi "By the way, how did you lose the charm? {w=0.1}Was it from a piece of jewelry or something?"
    kai  "Oh right, let me show you!"
    narrator "Kai rolls up his left sleeve, revealing a jade bracelet wrapped around his slender wrist."
    narrator "He shifts his hand, revealing a small section of gold that connects one end of the bracelet to the other. {w=0.1}With a brief motion, he reattaches the camellia charm, making a distinct clink while doing so."
    ...
    narrator "Kai flashes a wide grin at me, which I warmly reciprocate. Seeing him so cheerful after getting the charm back makes me feel happy for him."
    narrator "The bracelet must mean a lot to him."
    ...
    narrator "Kai begins barraging me with questions, getting closer as he asks each one. He's talking at lightning speed, making it hard to comprehend what he's trying to ask."
    narrator "Before I manage to even open my mouth to respond, a low, rumbling sound cuts Kai's questions off."
    narrator "The two of us stare at each other in silence, confused."
    emi ". . ."
    kai ". . ."
    emi ". . .Was that you?"
    ...
    narrator "Kai shakes his head, his hand pitifully cradling his gurgling stomach."
    ...
    scene cafe with fade
    show emi with dissolve
    narrator "I return to the counter and check the cooler where the off-display items are kept. Inside, I find a selection of desserts — pink macarons and a strawberry tart catch my eye."
    emi "(Hmm, I should take. . .)"
    
    # Choose what food to give to Kai
    menu:
        emi "(Hmm, I should take. . .)"
        "Take the macarons":
            call macarons
...
label macarons:
    narrator "I take the macarons and carefully place them in a small bag, making sure it's sealed shut. With the bag in hand, I make my way back to the cafe entrance."
    hide emi with dissolve
    scene cafe with fade
    show emi with dissolve
    emi "(Huh? Where'd he go? I thought I told him to wait here.)"
    narrator "I scan the cafe, searching for any sign of Kai."
    narrator "Suddenly, a pair of hands slam down on my shoulders, causing me to gasp and drop the macarons."
    ...
    narrator "He wipes a tear from his eye. After composing himself, he picks up the bag of macarons and hands them to me with a sheepish smile."
    ...
    narrator "With a huff, I push the bag of macarons into his arms."
    emi "There were some leftover macarons. It probably won't fill you up too much but it was what we had."
    narrator "Kai tugs at the bag, peering inside to inspect the macarons. His eyes shine brightly at the sight of them."
    ...
    narrator "Kai laughs as he grabs one of the macarons and take a bite, dancing in excitement. I laugh along with him at how happy he is over a small treat. "
    narrator "He eagerly gobbles down, delighting in each bite with animated reactions." 
    narrator "In a matter of minutes, he empties the bag and looks almost sad that there aren't any more."
    ...
    narrator "Kai laughs heartily, a proud glint in his eyes."
    ...
    kai "It was nice finally meeting you. You're going to have dinner with us at Yuugen House later right?"
    emi "Yeah, I think so. I don't have any plans tonight."
    kai "Sounds good, see you around then!"
    narrator "Kai excitedly waves as he leaves the cafe, the door chime tinkling behind his departure."
