label meeting_kai:
    ...
    unknown_k "It's kinda like a small golden thing. It should look like a flower of some kind."
    ...
    unknown_k "By the way, are you new around here? Ingram doesn't usually work with anyone in the cafe."
    unknown_k "Actually scratch that, I don't think I've ever seen Ingram working with {i}anybody{/i} in general. . ."
